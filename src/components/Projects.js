...
export default function Projects() {
    ...
    return (
      <div className="w-auto mt-16 lg:w-[70rem]">
        ...
        <div>
            ...
            <ul className="list-disc pl-6">
                ...
                <p className="mb-4 text-sm md:text-lg font-medium">I am currently working on a GIS Web Application for an LGU. 
               ...
               <Slider {...settings} className="w-[10rem] md:w-[60rem]">
                ...
                <p className="mb-4 text-sm md:text-lg font-medium">This Portfolio is written using "ReactJS" and "Tailwind".</p>
                ...
                <p className="mb-4 text-sm md:text-lg font-medium">A simple interactive drum kit project developed using JavaScript.A simple interactive drum kit project developed using JavaScript. This small application was part of a Udemy course that i took.</p>
                <p className="mb-4 text-sm md:text-lg font-medium">
