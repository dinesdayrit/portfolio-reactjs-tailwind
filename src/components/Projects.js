        ...
        <div>
            ...
            <ul className="list-disc pl-6 text-gray-300">
               ...
               <Slider {...settings} className="w-[10rem] md:w-[60rem]">
                ...
                <p className="mb-4 text-sm md:text-lg text-gray-300">This Portfolio is written using "ReactJS" and "Tailwind".</p>
                ...
                <p className="mb-4 text-sm md:text-lg text-gray-300">A simple interactive drum kit project developed using JavaScript.A simple interactive drum kit project developed using JavaScript. This small application was part of a Udemy course that i took.</p>
                <p className="mb-4 text-sm md:text-lg text-gray-300">
